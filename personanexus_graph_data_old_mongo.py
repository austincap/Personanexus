...
for persona in allpersonas:
    ...
    for persona2 in allpersonas:
        ...
        if persona[0] != persona2[0] and persona[2] != persona2[2]:
            ...
            for document in cursor: #maybe change to find_one to get rid of loop
...
with open("pnetdata.txt", "wt") as out_file:
...
for persona in allpersonas:
    for persona2 in allpersonas:
        ...
        tuple=()
        if tuple not in edges and persona[2] != persona2[2]:
            #print(personaID, persona2ID)
            tuple = (personaID,persona2ID)
            ...
            try:
                ...
                G.edge(personaID, persona2ID, color=weight_to_color(weight))   #GRAPHWIZ
                edges.append(tuple)
